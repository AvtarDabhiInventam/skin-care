  ...
  return (
    <Row className="max-height">
      ...
      <Card className="d-flex">
        <Image variant="top" src={testimonial1} />
        <Card.Body>
          <Card.Text>
            I don’t wear makeup very often, but when I do I go for a natural,
            no-makeup look. This skin tint and concealer gives exactly that. It
            helps even out my skin tone and looks very natural.
          </Card.Text>
