       ...
       <h2 className="section-heading text-center">recommendation Product</h2>
        <Row>
          <Col xs={12} sm={6} lg={4}>
            <Card className={`${styles.productCard}`}>
              <div className="img-container">
                <Image src={product2} className="course-img" alt="product" />
              </div>
          ...
          <Col xs={12} sm={6} lg={4}>
            <Card className={`${styles.productCard}`}>
              <div className="img-container">
                <Image src={product1} className="course-img" alt="product"/>
              </div>
              <Card.Body className="ps-0">
          ...
          <Col xs={12} sm={6} lg={4}>
            <Card className={`${styles.productCard}`}>
              <div className="img-container">
                <Image src={product3} className="course-img" alt="product"/>
              </div>
              <Card.Body className="ps-0">
